...
public class Startup {
    ...
    public void ConfigureServices(IServiceCollection services) {
        ...
        services.AddXaf(Configuration, builder => {
            builder.UseApplication<XafReportSchedulerBlazorApplication>();
            builder.Modules
                ...
                .Add<XafReportScheduler.Module.XafReportSchedulerModule>()
                .Add<XafReportSchedulerBlazorModule>();
            builder.ObjectSpaceProviders
                .AddSecuredEFCore(options => {
                    options.PreFetchReferenceProperties();
                })
                .WithDbContext<XafReportScheduler.Module.BusinessObjects.XafReportSchedulerEFCoreDbContext>((serviceProvider, options) => {
            ...
            builder.Security
                .UseIntegratedMode(options => {
                    ...
                    options.UserType = typeof(XafReportScheduler.Module.BusinessObjects.ApplicationUser);
                    // ApplicationUserLoginInfo is only necessary for applications that use the ApplicationUser user type.
                    // If you use PermissionPolicyUser or a custom user type, comment out the following line:
                    options.UserLoginInfoType = typeof(XafReportScheduler.Module.BusinessObjects.ApplicationUserLoginInfo);
